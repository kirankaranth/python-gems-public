...
class Watermark(ComponentSpec):
    ...
    class WatermarkProperties(ComponentProperties):
        ...
        isWatermarkingEnabled: Optional[bool] = False
    ...
    def onClickPSTab(self, portId: str, column: str, state: Component[WatermarkProperties]):
        ...
        isWatermarkingEnabled = any([wtr.isStreamingDF for wtr in outputWatermarks])
    ...
    class WatermarkCode(ComponentCode):
        ...
        def apply(self, spark: SparkSession, in0: DataFrame) -> DataFrame:
            if self.props.watermarks is not None and self.props.watermarks[0].isStreamingDF and self.props.watermarks[0].watermarkValue !="":
